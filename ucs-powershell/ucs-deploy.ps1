$ucsm = $Env:UcsHost
$ucsm_user = $Env:UcsUser
$ucsm_pass = $Env:UcsPass
...
$mo | Add-UcsComputePooledSlot -ModifyPresent -ChassisId "1" -SlotId 1
$mo | Add-UcsComputePooledSlot -ModifyPresent -ChassisId "1" -SlotId 2

$mo = Get-UcsOrg -Name ESX-PROD | Add-UcsServerPool -ModifyPresent  -Descr "ESX COMP HOSTS" -Name "ESX-COMP-HOST"
$mo | Add-UcsComputePooledSlot -ModifyPresent -ChassisId "1" -SlotId 7
$mo | Add-UcsComputePooledSlot -ModifyPresent -ChassisId "1" -SlotId 8
Complete-UcsTransaction
